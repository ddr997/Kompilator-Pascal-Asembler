...
{
       0,    24,    24,    26,    30,    31,    33,    41,    43,    45,
      46,    51,    53,    54,    56,    60,    64,    71,    78,   104,
     110,   111,   112
};
#endif
...
static const char *const yytname[] =
{
  ...
  "'+'", "'-'", "'('", "')'", "';'", "','", "':'", "'.'", "$accept",
  "start", "program", "identifier_list", "declarations", "type",
  "standard_type", "compound_statement", "statement_list", "statement",
...
{
      21,    17,    30,   -31,    15,   -31,    20,   -31,    -9,    16,
      23,   -31,   -31,    -3,    20,     4,   -31,     6,    22,    25,
      -6,   -31,    18,    24,     5,    19,     4,   -31,   -31,    26,
     -31,    28,   -31,   -31,     5,     5,     8,   -31,   -31,   -31,
     -31,    31,    -8,     5,     5,     5,   -31,   -31,    31,    31
};
...
static const yytype_int8 yydefact[] =
{
       ...
       8,     0,    21,    22,     0,     0,    14,    11,    13,     6,
      15,    19,     0,     0,     0,     0,    20,    18,    16,    17
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -31,   -31,   -31,    27,   -31,   -31,   -31,   -31,   -31,    11,
     -30
};
...
{
      25,    14,    15,    43,    41,    42,    44,    45,     9,    46,
      10,    18,    26,    47,    48,    49,    19,    32,    33,    43,
      34,    35,    44,    45,     1,    10,    22,    27,    28,     4,
       5,     6,     7,    24,    11,    12,    31,    38,    23,     0,
      37,    17,    43,     0,    39,    40
};

static const yytype_int8 yycheck[] =
{
       6,     4,     5,    11,    34,    35,    14,    15,    17,    17,
      19,     7,    18,    43,    44,    45,    12,    12,    13,    11,
      15,    16,    14,    15,     3,    19,    20,     9,    10,    12,
       0,    16,    12,     8,    18,    12,    12,    26,    16,    -1,
      21,    14,    11,    -1,    18,    17
};
...
static const yytype_int8 yystos[] =
{
      ...
      19,    18,    12,    26,     4,     5,    29,    25,     7,    12,
      30,    31,    20,    16,     8,     6,    18,     9,    10,    27,
      28,    12,    12,    13,    15,    16,    32,    21,    31,    18,
      17,    32,    32,    11,    14,    15,    17,    32,    32,    32
};
...
#line 33 "parser.y"
                                                              ...
                                                              {
                                                              printf("%d , %d\n", id_vector[i], i);
                                                              SYMTABLE.table[id_vector[i]].type_of_variable = (Variable_type)yyvsp[-1];
                                                              }
                                                              id_vector.clear();
                                                              }
