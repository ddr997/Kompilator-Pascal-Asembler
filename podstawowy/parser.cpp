...
static const char *const yytname[] =
{
  ...
  "T_ASSIGN", "T_INTEGER", "T_REAL", "ID", "NUMBER", "';'", "','", "':'",
  "$accept", "start", "program", "declarations", "list", "type", YY_NULLPTR
};
#endif
...
{
       5,     6,    11,    12,     8,     1,     0,    10,     9,    14,
       0,    15
};

static const yytype_int8 yycheck[] =
{
      13,    14,     8,     9,     0,    10,    -1,    10,    12,     9,
      -1,    10
};
...
#line 26 "parser.y"
                      {
                      symtable[yyvsp[-1]].type=(vartype)yyvsp[0];
                      symtable[yyvsp[-1]].address=next_adress;
                      if(yyvsp[0] == integer){
                        next_adress += 4;}
                      if(yyvsp[0] == real){
                        next_adress += 8;}
